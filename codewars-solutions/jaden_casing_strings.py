...
def to_jaden_case(string):
	...
	lista=string.split() #conver string in words list
	listaC=[]

	for word in lista:
		listaC.append(word.capitalize()) #append each capitalized word in the new list

	return(' '.join(listaC)) #convert new list in the final string
